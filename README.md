## Pedometer Plugin for Cordova, forked from official one, but with bug fixes 
...
- Android (when step counting hardware is available). Only live pedometer data is supported.
